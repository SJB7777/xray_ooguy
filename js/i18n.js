...
(function (window) {
  ...
  var translations = {
    ko: {
      ...
      about_what_title: "구성",
      about_f1_t: "RADIOMETRY",
      about_f1_d: "광자 플럭스와 슬릿 수용각, 흡수체 스택, 흡수 선량과 노출 시간 예산.",
      about_f2_t: "OPTICS",
      about_f2_d: "에너지·파장 변환, 복소 굴절률과 투과율, 회절 격자, 에너지 분해능과 열 드리프트.",
      about_f3_t: "GEOMETRY",
      about_f3_d: "브래그 각도, 격자면 간격, 상호공간 Q 벡터, 빔 풋프린트, 검출기 기하와 오일러 크래들 보정.",
      about_f4_t: "COHERENCE",
      about_f4_d: "시료 위 결맞음 길이, CDI / BCDI 오버샘플링, 그 기하가 도달할 수 있는 실공간 분해능.",
      about_f5_t: "DATA",
      about_f5_d: "두 열 스캔 파일 자동 인식, 로그 축 XY 플롯, 정규화와 구간 자르기, XRR 세그먼트 이어붙이기.",
      about_f6_t: "RECORD",
      about_f6_d: "한 번의 클릭으로 남기는 실험 로그와 세션 맥락. 외부 로그북에 붙여넣을 세션 헤더를 자동 생성합니다.",
      ...
      lat_r_d: "격자면 간격 <i class=\"formula\">d</i>",
      lat_r_q: "산란 벡터 <i class=\"formula\">|Q| = 2π/d</i>",
      lat_r_theta: "브래그 각도 <i class=\"formula\">θ (2θ)</i>",
      lat_r_vol: "단위포 부피 V",
      ...
      lat_refl_hkl: "<i class=\"formula\">h k l</i>",
      lat_refl_d: "<i class=\"formula\">d</i> (Å)",
      lat_refl_tth: "<i class=\"formula\">2θ</i> (°)",
      lat_refl_q: "|Q| (Å⁻¹)",
      ...
      theme_paper_name: "종이",
      theme_parchment_name: "양피지",
      theme_datasheet_name: "데이터시트",
      theme_blueprint_name: "청사진",
      theme_console_name: "콘솔",
      theme_crt_name: "터미널",
      theme_tokyo_name: "도쿄",
      ...
      toc_sec_about_desc: "각 스위트에 무엇이 들어 있는지, 설계 원칙, 만든 사람과 계산 근거",
      ...
      lbl_dspacing: "격자면 간격 <i class=\"formula\">d</i>",
      lbl_tth: "회절각 2θ",
      lbl_presets: "자주 쓰는 결정면 프리셋",
      lbl_inc_energy: "입사 에너지",
      res_calc_energy: "계산된 에너지 (E)",
      res_calc_d: "계산된 격자면 간격 (<i class=\"formula\">d</i>)",
      res_calc_tth: "계산된 회절각 <i class=\"formula\">2θ</i>",
      ...
      res_strain_eps: "변형률 <i class=\"formula\">ε</i>",
      res_strain_micro: "마이크로변형",
      res_strain_d: "측정된 <i class=\"formula\">d</i>",
      res_strain_shift: "피크 이동 <i class=\"formula\">Δ2θ</i>",
      geo_pxq_title: "검출기 픽셀 → Q",
      lbl_pxq_dx: "빔 중심에서 x",
      lbl_pxq_dy: "빔 중심에서 y",
      res_pxq_q: "산란 벡터 Q",
      res_pxq_tth: "산란각 <i class=\"formula\">2θ</i>",
      res_pxq_d: "면간 거리 <i class=\"formula\">d</i>",
      ...
      res_kie_spacing: "프린지 간격 <i class=\"formula\">Δθ</i>",
      ...
      res_target_twotheta: "목표 회절각 <i class=\"formula\">2θ</i>",
      res_target_theta: "목표 브래그각 <i class=\"formula\">θ</i>",
      ...
      res_cres_dr: "실공간 분해능 <i class=\"formula\">Δr</i>",
      ...
      res_cdi_pass: "충족: 나이퀴스트 오버샘플링 성립 (<i class=\"formula\">σ</i> ≥ 2.0)",
    ...
    en: {
      ...
      about_f1_t: "RADIOMETRY",
      about_f1_d: "Photon flux and slit acceptance, absorber stacks, absorbed dose and the exposure-time budget.",
      about_f2_t: "OPTICS",
      about_f2_d: "Energy-wavelength conversion, complex refractive index and transmittance, gratings, energy resolution and thermal drift.",
      about_f3_t: "GEOMETRY",
      about_f3_d: "Bragg angles, lattice d-spacing, reciprocal-space Q, beam footprint, detector geometry and Eulerian cradle correction.",
      about_f4_t: "COHERENCE",
      about_f4_d: "Coherence lengths at the sample, CDI / BCDI oversampling and the real-space resolution the geometry can reach.",
      about_f5_t: "DATA",
      about_f5_d: "Two-column scan files read automatically, XY plotting with a log axis, normalisation, range crop and XRR segment stitching.",
      about_f6_t: "RECORD",
      about_f6_d: "One-click experiment logs with session context, plus a formatted session header ready to paste into an external logbook.",
      ...
      lat_r_d: "Plane spacing <i class=\"formula\">d</i>",
      lat_r_q: "Scattering vector <i class=\"formula\">|Q| = 2π/d</i>",
      lat_r_theta: "Bragg angle <i class=\"formula\">θ (2θ)</i>",
      ...
      theme_paper_name: "Paper",
      theme_parchment_name: "Parchment",
      theme_datasheet_name: "Datasheet",
      theme_blueprint_name: "Blueprint",
      theme_console_name: "Console",
      theme_crt_name: "Terminal",
      theme_tokyo_name: "Tokyo",
      ...
      toc_sec_about_desc: "What is in each suite, the design principles, the author and the sources behind the numbers",
      ...
      lbl_dspacing: "Lattice d-spacing <i class=\"formula\">d</i>",
      ...
      res_calc_d: "Calculated d-spacing (<i class=\"formula\">d</i>)",
      res_calc_tth: "Calculated Angle <i class=\"formula\">2θ</i>",
      ...
      res_strain_eps: "Strain <i class=\"formula\">ε</i>",
      res_strain_micro: "Microstrain",
      res_strain_d: "Measured <i class=\"formula\">d</i>",
      res_strain_shift: "Peak shift <i class=\"formula\">Δ2θ</i>",
      geo_pxq_title: "Detector Pixel to Q",
      lbl_pxq_dx: "From beam centre, x",
      lbl_pxq_dy: "From beam centre, y",
      res_pxq_q: "Scattering vector Q",
      res_pxq_tth: "Scattering angle <i class=\"formula\">2θ</i>",
      res_pxq_d: "Plane spacing <i class=\"formula\">d</i>",
      ...
      res_kie_spacing: "Fringe spacing <i class=\"formula\">Δθ</i>",
      ...
      res_target_twotheta: "Target Angle <i class=\"formula\">2θ</i>",
      res_target_theta: "Target Angle <i class=\"formula\">θ</i>",
      ...
      res_cres_dr: "Real-space resolution <i class=\"formula\">Δr</i>",
      ...
      res_cdi_pass: "Pass: Nyquist oversampling satisfied (<i class=\"formula\">σ</i> ≥ 2.0)",
  ...
  var I18n = {
    ...
    applyTranslations: function () {
      ...
      //    No "Current language: X" line: the active button is already the
      //    answer, and a sentence restating it is one more string to keep in
      //    step with the control beside it.
